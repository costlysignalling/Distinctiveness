...
for(spec in 1:110){
  ...
  modify[16,2]<-modify[16,2]-0.015
  modify[17,2]<-modify[17,2]-0.015
...
w<-20
tiff("supp_distinctivization.tif",width=w,height=w/2.5,units="cm",res=600,compression = "lzw")
...
plot(asyme1,asyme2,xlab="Asymmetry before distinctivization",
     ylab="Asymmetry after distinctivization",pch=16,col=pcol,xlim=c(0.14,0.16),ylim=c(0.14,0.16))
abline(0,1,lty=2)
title("C",adj=0)
plot(disti1,disti2,xlab="Distinctiveness before distinctivization",
     ylab="Distinctiveness after distinctivization",pch=16,col=pcol,xlim=c(0.03,0.10),ylim=c(0.03,0.10))
abline(0,1,lty=2)
title("D",adj=0)
