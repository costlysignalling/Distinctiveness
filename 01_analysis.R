...
#here you can remove the observations where height is lacking
#d<-d[!is.na(d$BMI),]

#Row labels for summarization tabs
labtab<-c("Attractiveness","Sextypicality","Asymmetry","Distinctiveness","Height","BMI")
...
names(restab)[3:8]<-rownames(meantab)
...
descaleP(scale(d$Attractiveness),"")==d$Attractiveness
